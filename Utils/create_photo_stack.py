...
import os 
import numpy as np
folder = 'FRCNN_SD_outputs'
first_run = 0
folder_list = os.listdir(folder)
for model_folder in sorted(folder_list):
    if first_run == 0:
        ...
        for image in image_list:
            order_dict = {4:'0b86e07a-img-00041-00001.jpg',3:'0b9cf7fe-img-00005-00001.jpg',1:'0c80e5ad-img-00112-00002.jpg',0:'0dd3415d-img-00095-00001.jpg',2:'0e713f58-img-00087-00001.jpg'}

            #define paths
            original_image_path = f"UNET/val_images/{order_dict[int(image[0])]}"
            mask_image_path = f"UNET/val_masks/{order_dict[int(image[0])]}"
            prediction_image_path = f"{top_dir}/{image}"
            #load images
    ...
    first_run = 1
plt.axis('off')
output = f"FRCNN_stacks/{model_folder}_stack.png"
